...
MEAL_SLOT_SCHEDULES: dict[int, tuple[SlotSpec, ...]] = {
    2: (
        SlotSpec("lunch", 0.50, 0, "Lunch", "13:00"),
        SlotSpec("dinner", 0.50, 1, "Dinner", "20:00"),
    ),
    3: (
        SlotSpec("breakfast", 0.30, 0, "Breakfast", "08:00"),
        SlotSpec("lunch", 0.40, 1, "Lunch", "13:00"),
        SlotSpec("dinner", 0.30, 2, "Dinner", "20:00"),
    ),
    4: (
        SlotSpec("breakfast", 0.25, 0, "Breakfast", "08:00"),
        SlotSpec("lunch", 0.35, 1, "Lunch", "13:00"),
        SlotSpec("snack", 0.10, 2, "Snack", "16:00"),
        SlotSpec("dinner", 0.30, 3, "Dinner", "20:00"),
    ),
    5: (
        SlotSpec("breakfast", 0.22, 0, "Breakfast", "08:00"),
        SlotSpec("mid_morning_snack", 0.08, 1, "Mid-Morning Snack", "10:30"),
        SlotSpec("lunch", 0.30, 2, "Lunch", "13:00"),
        SlotSpec("evening_snack", 0.12, 3, "Evening Snack", "17:00"),
        SlotSpec("dinner", 0.28, 4, "Dinner", "20:00"),
    ),
    6: (
        SlotSpec("breakfast", 0.20, 0, "Breakfast", "08:00"),
        SlotSpec("mid_morning_snack", 0.08, 1, "Mid-Morning Snack", "10:30"),
        SlotSpec("lunch", 0.27, 2, "Lunch", "13:00"),
        SlotSpec("afternoon_snack", 0.09, 3, "Afternoon Snack", "15:30"),
        SlotSpec("evening_snack", 0.08, 4, "Evening Snack", "17:30"),
        SlotSpec("dinner", 0.28, 5, "Dinner", "20:00"),
    ),
}
